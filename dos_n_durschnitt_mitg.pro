pro dos_n_durschnitt_mitg
;
;   NAME: dos_n_durchschnitt_mitg.pro
;
;   ZWECK: - Berechnung der Durchschnitte der gemessenen Anzahldichte des DPOPS
...
; ------------------- USA Betrachtung: 02.06.2022 ---------------------------------------------------------------------
  ...
  for i = idx_sage_beg, idx_sage_end do begin
    sage_einzel = plot(anzahldichte_mit_genauigkeitsparameter[sage_usa_index_2022[i:i],*],altitude, NAME = "SAGE III on ISS Einzelmessung",$
  ...
  for i = 0, 89 do begin
    mitg_durchschnitt_sage_20220602[i] = mean(anzahldichte_mit_genauigkeitsparameter[sage_usa_index_2022[idx_sage_beg:idx_sage_end],i], /NAN)
  endfor
  ...
  ; SAGE Einzelmessungen plotten
  for i = idx_sage_beg, idx_sage_end do begin
    sage_einzel = plot(anzahldichte_mit_genauigkeitsparameter[sage_usa_index_2021[i:i],*],altitude, NAME = "SAGE III on ISS Einzelmessung",$
      COLOR = "light blue", /OVERPLOT, THICK=2)
  endfor
  ...
  for i = 0, 89 do begin
    mitg_durchschnitt_sage_20210806[i] = mean(anzahldichte_mit_genauigkeitsparameter[sage_usa_index_2021[idx_sage_beg:idx_sage_end],i], /NAN)
  endfor
...
; ------------------- USA Betrachtung: DPOPS: 26.07.2021, SAGE: 27.07.2021  ---------------------------------------------------------------------
  ...
  for i = 0, 89 do begin
    mitg_durchschnitt_sage_20210802[i] = mean(anzahldichte_mit_genauigkeitsparameter[sage_zonal_index_2021[idx_sage_beg:idx_sage_end],i], /NAN)
    mitg_abweichung_sage_20210802[i] = stddev(anzahldichte_mit_genauigkeitsparameter[sage_zonal_index_2021[idx_sage_beg:idx_sage_end],i], /NAN)
  endfor
...
; ------------------- zonale Betrachtung: 31.5.2022 ---------------------------------------------------------------------
  ...
  for i = 0, 89 do begin
    mitg_durchschnitt_sage_20220531[i] = mean(anzahldichte_mit_genauigkeitsparameter[sage_usa_index_2022[idx_sage_beg:idx_sage_end],i], /NAN)
    mitg_abweichung_sage_20220531[i] = stddev(anzahldichte_mit_genauigkeitsparameter[sage_usa_index_2022[idx_sage_beg:idx_sage_end],i], /NAN)
  endfor
...
; ------------------- zonale Betrachtung: 08.06.2022 ---------------------------------------------------------------------
  ...
  for i = 0, 89 do begin
    mitg_durchschnitt_sage_20220608[i] = mean(anzahldichte_mit_genauigkeitsparameter[sage_zonal_index_2022[idx_sage_beg:idx_sage_end],i], /NAN)
    mitg_abweichung_sage_20220608[i] = stddev(anzahldichte_mit_genauigkeitsparameter[sage_zonal_index_2022[idx_sage_beg:idx_sage_end],i], /NAN)
  endfor
  
  ; Plotten des SAGE Durchschnittes
  sage_durchschnitt = plot(mitg_durchschnitt_sage_20220608, altitude, /OVERPLOT, THICK = 2, COLOR = "blue", NAME = "SAGE III on ISS Durchschnitt")
